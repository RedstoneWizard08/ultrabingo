...
public static class LevelStatsPanelPatchStart {
    [HarmonyPostfix]
    public static async void ShowBingoPanel(LevelStatsEnabler instance) {
        ...
        if (GameManager.IsInBingoLevel && GetSceneName() != "Main Menu") {
            ...
            var inGamePanel = Object.Instantiate(AssetLoader.BingoInGameGridPanel, instance.gameObject.transform);
            ...
            var votePanel = Object.Instantiate(AssetLoader.BingoVotePanel, instance.gameObject.transform.parent);
