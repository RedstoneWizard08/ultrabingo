...
public class NetworkManager {
    ...
    public readonly string ServerMapPoolCatalogURL;
    ...
    public NetworkManager() {
        ...
        ServerMapPoolCatalogURL = $"http://{host}:{port}/bingoMapPool.toml";
    ...
    /// </summary>
    public async Task<string?> FetchCatalog(string urlToRequest) {
        try {
            var responseTomlRaw = await _client.GetStringAsync(urlToRequest);
